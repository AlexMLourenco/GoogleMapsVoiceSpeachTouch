...
public class GenFusionSCXML {
    ...
    fg.Sequence(Speech.CHANGE, SecondMod.CAR, Output.CHANGE_CAR);
    fg.Complementary(Speech.CHANGE, SecondMod.BIKE, Output.CHANGE_BIKE);
    fg.Complementary(Speech.CHANGE, SecondMod.BUS, Output.CHANGE_BUS);
    fg.Complementary(Speech.CHANGE, SecondMod.FOOT, Output.CHANGE_FOOT);
